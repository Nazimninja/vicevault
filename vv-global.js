...
.vv-bar-label .vv-bl-accent { color: #ff3d9a; }
...
.vv-bar-cta:hover { background: #c830ff; transform: translateY(-1px); }
...
.vvm-deal.selected {
  background: #131320;
  box-shadow: inset 0 0 0 2px var(--deal-color, #ff3d9a);
}
.vvm-deal-badge {
  font-family: 'Barlow Condensed', sans-serif;
  font-size: 0.6rem;
...
.vvm-feats li::before { content: '✓'; color: #ff3d9a; flex-shrink: 0; margin-top: 1px; font-weight: 700; }
...
.vvm-select-check {
  ...
  border-radius: 50%;
  background: var(--deal-color, #ff3d9a);
  display: flex; align-items: center; justify-content: center;
...
.vvm-email:focus { border-color: #ff3d9a; }
.vvm-submit {
  background: #ff3d9a;
  color: #030308;
  font-family: 'Barlow Condensed', sans-serif;
...
.vvm-submit:hover { background: #c830ff; transform: translateY(-1px); }
    ...
    overlay.innerHTML = `
      <div id="vv-modal">
        ...
        <div class="vvm-success" id="vvm-success">
          ...
          <div class="vvm-success-sub">Check your email for confirmation. On launch day we'll send you a direct checkout link with your locked price. You're <span id="vvm-pos" style="color:#ff3d9a;font-weight:700">#12,849</span> in line.</div>
        </div>
      </div>
    `;
